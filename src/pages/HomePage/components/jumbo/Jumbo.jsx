      ...
      <div className="jumbo">
        <div>
          ...
          <div className="sm:h-[440px]">
            <figure className="image-wrapper w-[190px] sm:w-[350px] md:w-[400px] lg:w-[500px] xl:w-[650px] float-right">
              <img src={dogJumbo} alt="" />
            </figure>
            <p className="sm:text-[20px]   sm:pt-8 lg:pt-28">
              ArisPedigree online’s database offers free pedigree reports for
              dogs of all breeds, from all over the world. You can start
              exploring the website checking our{" "}
              <Link to="dogs-list">dog’s list </Link>
              and browsing through all dogs available in the database or using
              our <Link to="search-a-dog">search page </Link>
              to find dogs fulfilling your criteria. Otherwise you can select a
              breed in the list below.
            </p>
          </div>
        </div>
